...
class YOLOv8(nn.Module):
    ...
    def __init__(self, num_classes=80, width_multiple=1.0, depth_multiple=1.0, 
        ...
        # Backbone - all backbones use standard implementations
        # CSPDarknet is automatically mapped to ResNet34
...
def create_model(num_classes=None, width_multiple=None, depth_multiple=None, 
    ...
    Args:
        ...
        width_multiple: Width scaling factor (deprecated for standard backbones)
        depth_multiple: Depth scaling factor (deprecated for standard backbones)
        backbone_name: Backbone network name. Options:
            - 'CSPDarknet' (default, maps to ResNet34 standard implementation)
...
if __name__ == '__main__':
    ...
    # Test with CSPDarknet (now uses ResNet34 standard implementation)
    print("\n--- Testing CSPDarknet (ResNet34) backbone ---")
    ...
    # Test with ResNet34 backbone (without pretrained for faster testing)
    print("\n--- Testing ResNet34 backbone ---")
    model_resnet = create_model(num_classes=80, width_multiple=0.5, depth_multiple=0.67,
                                backbone_name='ResNet34', backbone_pretrained=False)
